...
class NationalSavingsCertificate extends StatefulWidget {
  const NationalSavingsCertificate({super.key});

  @override
  State<NationalSavingsCertificate> createState() => _NationalSavingsCertificateState();
}

class _NationalSavingsCertificateState extends State<NationalSavingsCertificate> {
  // Controllers
